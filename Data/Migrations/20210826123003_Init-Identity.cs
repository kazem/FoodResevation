        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Decription = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 8, 26, 17, 0, 3, 389, DateTimeKind.Local).AddTicks(9071))
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeriodDefinitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PeriodDefinitions_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreationRegister = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 8, 26, 17, 0, 3, 399, DateTimeKind.Local).AddTicks(3524))
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestFoodReservations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestFoodReservations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
